...
export const Header: React.FC<IHeaderProps> = ({ fileName, centerButtons, rightButtons }) => {
  return (
    <div className="sticky top-0 z-50 w-[stretch] h-12 bg-background text-foreground flex items-center justify-between px-4 border-b border-border box-content py-[4px] mb-2.5">
